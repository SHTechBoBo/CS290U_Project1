...
class MySyntheticBurstVal(torch.utils.data.Dataset):
    ...
    def __init__(self, root=None, initialize=True):
        ...
        """
        root = "./yehw2024_project1/generated_imgs/" if root is None else root
        self.root = root
        
        # according to the .png number in the folder
        imgs_num = len(os.listdir("./yehw2024_project1/original_imgs/"))
