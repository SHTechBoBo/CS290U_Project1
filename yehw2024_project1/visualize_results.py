...
from yehw2024_project1.burst_val_set import MySyntheticBurstVal
...
def visualize_results(setting_name):
    ...
    expr_module = importlib.import_module('yehw2024_project1.{}'.format(setting_name))
    ...
    for idx in range(len(dataset)):
        ...
        cv2.imwrite(os.path.join(path, "gt.png"), gt)
